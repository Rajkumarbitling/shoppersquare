...
<div id="singleColumn">
    ...
    <c:if test="${!empty orderFailureFlag}">
        ...
        <form class="form form-horizontal" id="checkoutForm" action="<c:url value='purchase'/>" method="post">
        <table id="checkoutTable">
          <c:if test="${!empty validationErrorFlag}">
            ...
            <tr>
                ...
                <div id="infoBox" style="text-align: left">
        ...
        <table id="priceBox" style="align-content: center">
            <tr>
