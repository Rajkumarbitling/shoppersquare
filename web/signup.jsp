<%-- 
    Document   : signup
    Created on : 19 Jul, 2017, 1:50:52 PM
    Author     : Rajkumar
--%>
                    ...
                    <div class="login-form-grids">
                        ...
                        <form action="registration.jsp" method="post">
                            ...
                            <%
                                    ...
                                    if (error_msg != null) {%>
                            <div class="clearfix"></div>
                            <span class="alert alert-danger col-md-12"><%=error_msg%> Please <a href="/signin.jsp">Login</a></span>
                            <% }
                            %>
                            <input type="text" name="fname" placeholder="First Name..." required=" " >
                            <input type="text" name="lname" placeholder="Last Name..." required=" " >
                            <input type="text" name="uname" placeholder="User Name... (Remember This)" required=" " ></br>
                            <input type="email" name="email" placeholder="Email Address" required=" " >
                            <input type="password" id="password" name="pass" placeholder="Password" required=" " >
                            <input type="password" id="confirm_password" placeholder="Password Confirmation" required=" " >
