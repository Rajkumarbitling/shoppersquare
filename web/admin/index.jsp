...
<div id="adminMenu" class="alignLeft">
    ...
    <p><a href="<c:url value='addproduct.jsp'/>">Manage Products</a></p>
        ...
        <tr class="tableRow"
            ...
            <td colspan="2">
                ...
                <a href="orderRecord?${order.id}" class="noDecoration">
                    <strong>view order summary </strong></a><span class="fa fa-arrow-right"></span></td>
        </tr>
    </table>
        ...
        <tr class="tableRow"
            ...
            <td colspan="2">
                ...
                <a href="customerRecord?${customer.id}" class="noDecoration">
                    <strong>view customer details </strong></a><span class="fa fa-arrow-right"></span></td>
        </tr>
    </table>
